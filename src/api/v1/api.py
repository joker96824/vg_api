...
from .endpoints import cards, decks, auth, friendship, websocket, rooms, match, battles, coin
...
# 注册猜拳相关路由
api_router.include_router(coin.router, prefix="/battles/coin", tags=["coin"])
