...
async def create_deck(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"创建卡组失败: {str(e)}")
...
async def get_deck(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"获取卡组详情失败: {str(e)}")
...
async def update_deck(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"更新卡组失败: {str(e)}")
...
async def delete_deck(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"删除卡组失败: {str(e)}")
...
async def update_deck_preset(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"更新卡组预设值失败: {str(e)}")
...
async def copy_deck(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"复制卡组失败: {str(e)}")