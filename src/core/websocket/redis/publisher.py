...
class RedisPublisher:
    ...
    async def publish_game_start(self, battle_id: str, room_id: str) -> None:
        """
        发布游戏开始消息
        ...
        try:
            # 发布消息到 Redis
            logger.info(f"发布游戏开始消息: 房间ID={room_id}, 对战ID={battle_id}")
            ...
            logger.info(f"游戏开始消息已发布到 Redis: 房间ID={room_id}, 对战ID={battle_id}")
